    ...
    return (
        <div className="space-y-12 max-w-7xl mx-auto px-4">
            ...
            <header className="flex flex-col gap-2">
                ...
                <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">Terminology Translation</h1>
                <p className="text-muted-foreground md:text-lg italic text-sm">
            ...
            <motion.div
                ...
                className="bg-card border border-border rounded-3xl p-6 md:p-10 relative overflow-hidden shadow-sm"
            >
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    <div className="flex flex-col md:grid md:grid-cols-7 gap-3 md:gap-4 mb-6 md:mb-8 items-center relative">
                        ...
                        <div className="md:col-span-1 flex justify-center rotate-90 md:rotate-0">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full bg-primary text-primary-foreground py-4 md:py-5 rounded-2xl font-bold hover:scale-[1.01] active:scale-95 transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-2 md:gap-3 text-lg md:text-xl disabled:opacity-50"
                    >
            ...
            <div className="grid md:grid-cols-2 gap-8">
                {/* Source Definition */}
                <div className="bg-card border border-border rounded-2xl p-6 md:p-8 shadow-sm space-y-4 md:space-y-6">
                    ...
                    <div className="p-5 md:p-6 bg-muted/30 rounded-2xl border border-border">
                        ...
                        <div className="text-lg md:text-xl font-bold italic">{result ? result.source_term : "---"}</div>
                    </div>
                </div>
                ...
                <div className="bg-card border border-border rounded-2xl p-6 md:p-8 shadow-sm space-y-4 md:space-y-6">
                    ...
                    <div className="p-5 md:p-6 bg-zinc-950 rounded-2xl border border-white/5 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 p-4 opacity-[0.02] scale-150 group-hover:scale-110 transition-transform">
                            <Languages className="w-20 md:w-24 h-20 md:h-24 text-white" />
                        </div>
                        <div className="relative z-10">
                            <div className="text-[10px] md:text-sm font-bold text-zinc-500 uppercase tracking-widest mb-1">ICD-11 Code</div>
                            <div className="text-2xl md:text-3xl font-mono font-bold text-emerald-400">{result ? result.target_code : "---"}</div>
                            <div className="mt-3 md:mt-4 flex flex-wrap items-center gap-2">
                                <span className={`px-2 md:px-3 py-1 rounded-full text-[9px] md:text-[10px] font-bold uppercase tracking-widest border ${result ? "bg-emerald-500/10 text-emerald-500 border-emerald-500/20" : "bg-zinc-800 text-zinc-500 border-zinc-700"}`}>
                                    {result ? result.status : "Status: Pending"}
                                </span>
                                <span className="text-[10px] md:text-xs text-zinc-500 italic">Verified by Neural Engine</span>
                            </div>
                        </div>
                    </div>
                </div>
