    ...
    return (
        <div className="space-y-10 max-w-6xl mx-auto">
            <header className="flex flex-col gap-2">
                ...
                <h1 className="text-4xl font-bold tracking-tight">FHIR Resources</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    <motion.div
                        ...
                        className="bg-card border border-border rounded-3xl p-8 hover:shadow-2xl hover:border-primary/40 transition-all cursor-pointer group relative overflow-hidden"
                    >
            ...
            >
                <div className="flex items-center justify-between px-10 py-8 border-b border-border bg-muted/20 backdrop-blur-sm">
                ...
                <div className="p-10 bg-muted/10">
                    <pre className="overflow-x-auto text-base font-mono leading-relaxed p-8 bg-zinc-950 rounded-3xl border border-white/5 shadow-inner">
